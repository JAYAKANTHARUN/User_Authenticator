...
const UpdateProfile = () => {
    ...
    const handleupdate = async () => {
        ...
        let result = await fetch('http://127.0.0.1:4000/update', {
            ...
            body: JSON.stringify({ username, phonenumber, gender, dob, email, profilephoto, oldemail }),
        })
    ...
    return (
        <div className='flex justify-center items-start h-[180vh] color4bg '>
            <div className='color1bg border-[2px] border-[#00ADB5] rounded-3xl sm:p-[40px] p-[20px] sm:mt-[100px] mt-[50px] text-center sm:w-[600px] w-[290px]'>
                ...
                <input className='focus:ring-[1px] focus:ring-[#00ADB5] outline-none font-poppins text-center text-[18px] border-[1px] p-[10px] sm:w-[350px] w-[250px] rounded-3xl ' value={email} onChange={(e) => { setemail(e.target.value) }} type="email" placeholder='Enter email' /><br /> <br />
